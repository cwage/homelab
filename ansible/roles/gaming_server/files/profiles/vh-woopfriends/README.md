# Valheim Profile: vh-woopfriends

This directory contains profile-specific files for the vh-woopfriends server.
...
- Server password is stored in OpenBao at `kv/services/gaming/vh-woopfriends`
